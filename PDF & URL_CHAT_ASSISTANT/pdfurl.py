...
from langchain_core.schema import HumanMessage, AIMessage  # Ensure you have these imports
import os
...
groq_api_key = os.getenv("GROQ_API_KEY")  # Use the key from the .env file
    ...
    if uploaded_files:
        ...
        with col1:
            ...
            for message in session_history.messages:
                # Check the type of message and display accordingly
